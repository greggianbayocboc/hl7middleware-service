...
class HL7Test {
    ...
    fun transmit(): String? {
        val msg  = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01|12345|P|2.5\r"+
                ...
                "PV1|0001|I|D.ER^1F^M950^01|ER|P000998|11B^M011^02|070615^BATMAN^GEORGE^L|555888^OKNEL^BOB^K^DR^MD|777889^NOTREAL^SAM^T^DR^MD^PHD|ER|D.WT^1A^M010^01|||ER|AMB|02|070615^VOICE^BILL^L|ER|000001916994|D||||||||||||||||GDD|WA|NORM|02|O|02|E.IN^02D^M090^01|E.IN^01D^M080^01|201802132124|000101010000|||||5555112333|||666097^DNOTREAL^MANNY^P\r"+
        ...
        var connection = context.newClient("localhost", 22223, useTls)
