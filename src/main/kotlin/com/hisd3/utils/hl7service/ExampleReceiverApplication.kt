...
class ExampleReceiverApplication<E> : ReceivingApplication<Message> {
...
//
//
//    constructor(_orderSlipRepository: OrderSlipRepository, _labResultItemRepository: LabResultItemRepository)
//    {
//        orderSlipRepository = _orderSlipRepository
//        labResultItemRepository = _labResultItemRepository
//
//    }
